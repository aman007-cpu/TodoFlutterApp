...
class _homepageState extends State<homepage> {
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    taskwidgets(Colors.blue, "Meeting with someone", "9:00 AM"),
                    taskwidgets(Colors.green, "Take Your Medicine", "9:00 AM"),
                  ],
                ),
              )),
              Container(
  ...
  Slidable taskwidgets(Color color, String title, String time) {
    return Slidable(
